(function(){
	document.getElementById('ipad-console').innerHTML += '<center><span style="color:red; font-weight:bold;"> -> iPad Console <- </span></center><br />';
	if (window.navigator.userAgent.toLowerCase().match(/ipad/g)) {
